 ...
 <div class="container">
  ...
  <div class="newsfeed">
    ...
    <div class="newsfeed" id="about">   
        <div class="post">
            ...
            <p>I'm a BSIT student
                ...
                to music and watching movies and
                series. I can draw in both
                traditional and digital styles.</p>
            <i id="posticon" class="fa-regular fa-heart"></i>
            <i id="posticon" class="fa-regular fa-comment"></i> 
            <i id="posticon" class="fa-regular fa-share-from-square"></i>
        </div> 
    ...
    <div style="margin-top: 250px;" class="newsfeed" id="music">
        <div class="post">
            ...
            <div class="music-container">
                ...
                <img src="RES/a1.jpg" alt="Album Cover">
            ...
            <div class="audio-controls" >
               <audio controls>
                   <source src="RES/m1.mp3" type="audio/mpeg">
               </audio>
           </div>
        </div>
            <i id="posticon" class="fa-regular fa-heart"></i>
    ...
    <div class="post">
        ...
        <div class="music-container">
            <div class="music-info">
            <img src="RES/a2.jpg" alt="Album Cover">
            <div class="song-details">
               <h3>Koiiro</h3>
               <p>By Mosawo</p>
           </div>
        ...
        <div class="audio-controls" >
           <audio controls autoplay>
               <source src="RES/m2.mp3" type="audio/mpeg">
           </audio>
       </div>
    </div>
        <i id="posticon" class="fa-regular fa-heart"></i>
...
<div class="post">
    ...
    <div class="music-container">
        <div class="music-info">
        <img src="RES/a3.jpg" alt="Album Cover">
        <div class="song-details">
           <h3>To My Youth</h3>
           <p>By Bolbbalgan4</p>
       </div>
    ...
    <div class="audio-controls" >
       <audio controls>
           <source src="RES/m3.mp3" type="audio/mpeg">
       </audio>
   </div>
</div>
    <i id="posticon" class="fa-regular fa-heart"></i>
   ...
   <div style = "margin-top: 10px;"class="user-post" id="friends">
    ...
    <div class="gallery" id="gallery">
        ...
        <div class="gallery-item">
            <img src="RES/g1.jpg" alt="Photo 1">
            <div class="img-des">
            <p class="img-des">My dream destination is Japan.</p>
            </div>
        </div>
        <div class="gallery-item">
            <img src="RES/g2.jpg" alt="Photo 2">
            <div class="img-des">
            <p class="img-des">I want to attend the Lantern Festival.</p>
            </div>
        </div>
        </div>
        <div class="gallery-row">
        <div class="gallery-item">
            <img src="RES/g3.jpg" alt="Photo 4">
            <div class="img-des">
            <p class="img-des">I love to watch Fireworks Display.</p>
            </div>
        </div>
        <div class="gallery-item">
            <img src="RES/g4.jpg" alt="Photo 5">
            <div class="img-des">
            <p class="img-des">I want to go to South Korea.</p>
            </div>
        </div>
    ...
    <div class="gallery-row">
        <div class="gallery-item">
            <img src="RES/g5.jpg" alt="Photo 4">
            <div class="img-des">
            <p class="img-des">My first favorite Anime Series.</p>
            </div>
        </div>
        <div class="gallery-item">
            <img src="RES/g6.jpg" alt="Photo 5">
            <div class="img-des">
            <p class="img-des">One of my favorite Anime Movies.</p>
            </div>
        </div>
    </div>
    <div class="gallery-row">
        <div class="gallery-item">
            <img src="RES/g9.jpg" alt="Photo 4">
            <div class="img-des">
            <p class="img-des">My favorite Korean Drama.</p>
            </div>
        </div>
        <div class="gallery-item">
            <img src="RES/g8.jpg" alt="Photo 5">
            <div class="img-des">
            <p class="img-des">One of my favorite Korean Mystery Series.</p>
            </div>
        </div>
    </div>
    <div class="gallery-row">
        <div class="gallery-item">
            <img src="RES/g7.jpg" alt="Photo 4">
            <div class="img-des">
            <p class="img-des">My most favorite Male Anime Character.</p>
            </div>
        </div>
        <div class="gallery-item">
            <img src="RES/g10.jpg" alt="Photo 5">
            <div class="img-des">
            <p class="img-des">This cat looks just like my favorite cat—Kyo.</p>
            </div>
        </div>
    </div>
